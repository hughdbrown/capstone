...
c = Counter((d["timestamp"].day, d["timestamp"].hour, d["timestamp"].minute, d["country"]) for d in items if "country" in d)
t = [
...
c = Counter((d["timestamp"].day, d["timestamp"].hour, d["timestamp"].minute) for d in items)
t = [
